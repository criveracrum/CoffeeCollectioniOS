...
var indonesiaSulawesi = Coffee(origin: "Indonesian", name: "Sulawesi", photo: "Indonesia", description: "Sulawesi is a rare single origin, known only to the most fervent of coffee lovers. It’s hard to get your hands on a good Sulawesi coffee: without the name appeal of Sumatra, or Java, Sulawesi remains one of Indonesian coffee’s best-kept secrets. So when Scott, from Fundamental Coffee Company, told us he was bringing in a special new Sulawesi, we couldn’t wait to sink into the experience. Scotch, cigars, Sulawesi: three things to slow down and savor.",taste : "Tobacco, Floral, Savory");
var costaReserve = Coffee(origin: "South American", name: "Reserve #401", photo: "South America", description: "Costa Rican coffee has always had a timeless, romantic appeal. Clean, sweet, and classic, the best Costa Rican coffees showcase an elegant simplicity, a profile that “tastes like coffee”-- only better! Whenever we’re in the mood for an easy-to-love cup, we’re drawn to the Costa Rica Reserve from Vashon Island Coffee Roasterie. This medium-roast cup opens with a rich aroma, full of cocoa and toasted hazelnut, a subtle woodsy spice. The body is creamy and smooth, like caramel, or nougat, and the chocolate hazelnut flavors carry into a long, silky finish. But the true romance of this cup goes way beyond its sweet flavors.",taste : "Caramel, Nutty, Chocolate");
var elSalvadorAyutepeque = Coffee(origin: "South American", name: "Ayutepeque", photo: "South America", description: "Wake up, brew it up, cheer up: this El Salvador does everything but make your bed in the morning. Water Avenue is proud of their Scandinavian-inspired roasting style, which results in a coffee with rich, full flavors: tart apple, savory caramel, and sweet almond amaretto liqueur. This coffee may, in fact, become your new favorite adult beverage.",taste : "Caramel, Cocoa, Red Apple");
